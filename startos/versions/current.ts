...
export const current = VersionInfo.of({
  ...
  version: production ? productionVersion : '0.1.10:0',
  releaseNotes: {
    en_US: production
      ...
      : `Staging version on Manifold master f06c7bbd. Includes the Fedimint v0.11.2-fedi4 P2P deadlock fix and guardian fee policy updates. Staging only; test funds and disposable data.`,
  },
  migrations: {
    up: async () => {},
    down: IMPOSSIBLE,
